...
jackson_experiments = {
    'jackson_precision_uniform': {
        ...
        'estimator': 'None',
        'query': ApproxQuery(
            qtype='pt', min_precision=0.95,
            min_recall=0.95, delta=0.1,
            budget=1514),
    ...
    "jackson_recall_uniform": {
        ...
        'estimator': 'None',
        "query": ApproxQuery(
            qtype="rt", min_recall=0.95,
            min_precision=0.95, delta=0.1,
            budget=655),
    ...
    "jackson_recall_imp": {
        ...
        'estimator': 'None',
        "query": ApproxQuery(
            qtype="rt", min_recall=0.7,
            min_precision=0.95, delta=0.05,
            budget=931),
